...
export default function NewCollectionModal({ onClose }) {
  ...
  return ReactDOM.createPortal(
    <div className={darkMode?'dark':''}>
      ...
      ></div>
      <div className={`rounded-lg shadow-lg w-1/5 h-1/2 min-w-64 min-h-[200px] flex flex-col fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 ${darkMode ? 'bg-gray-800' : 'bg-white'} p-4 z-50`}>
